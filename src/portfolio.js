...
const seo = {
  title: "Krittinaphat Srisuwan | Portfolio",
  description:
    "A computer science student who is passionate about working with data.",
  og: {
    title: "Rohan Portfolio",
    type: "website",
    url: "http://salene96x.github.io/",
  },
};
...
const greeting = {
  title: "Greetings!",
  sub: "Krittinaphat Srisuwan",
  logo_name: "Krittinaphat Srisuwan",
  resumeLink: "",
};
  ...
  competitiveSites: [
    {
      ...
      profileLink: "https://github.com/salene96x",
    },
    // {
    //   siteName: "HackerRank",
    ...
    // },
    {
      ...
      profileLink: "https://www.kaggle.com/salene96x",
    },
    // {
    ...
    // },
    {
      ...
      profileLink: "https://www.linkedin.com/in/krittinaphat-srisuwan-459bb8249/",
    },
    // {
    //   siteName: "HashNode",
...
const skills = {
  data: [
    ...
    },
    {
      ...
      skills: [
        "⚡ Building API connect front-end to back-end.",
        "⚡ Creating SQL database to store data from front-end.",
